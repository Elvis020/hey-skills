...
**Personal skills live in agent-specific directories (`<agent-skills-directory>` for an agent, `<agent-skills-directory>/` for another agent)** 
...
- Project-specific conventions (put in project instruction files)
